...
# Bundle, validate, and lint the checked-in spec artifacts
...
The underlying package scripts are `pnpm run bundle:api-spec`,
`pnpm run validate:api-spec`, and `pnpm run lint:api-spec`.
